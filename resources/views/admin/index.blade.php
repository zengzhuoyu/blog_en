...
@section('content')
	...
	<div class="menu_box">
		<ul>
			...
			<li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-group"></i>友 链</a></li>
			<!-- <li><a href="{{url('admin/navs/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加导航</a></li>                	 -->
			<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-list-ol"></i>导 航</a></li>		
			<!-- <li><a href="{{url('admin/config/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加配置项</a></li>                	 -->
