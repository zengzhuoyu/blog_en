    ...
    <form action="{{url('admin/config/'.$field->conf_id)}})}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>类型：</th>
                <td>
                    <input type="radio" name="conf_type" value="input" @if($field->conf_type=='input') checked @endif onclick="showTr()">input　
                    <input type="radio" name="conf_type" value="textarea" @if($field->conf_type=='textarea') checked @endif onclick="showTr()">textarea　
                    <input type="radio" name="conf_type" value="radio" @if($field->conf_type=='radio') checked @endif onclick="showTr()">radio
                </td>
            </tr>
            <tr class="conf_value">
                <th>类型值：</th>
                <td>
                    <input type="text" class="lg" name="conf_value" value="{{$field->conf_value}}">
